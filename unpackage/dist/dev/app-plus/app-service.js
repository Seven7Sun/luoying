...
(function(vue) {
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__file", "D:/Uniapp/luoying/pages/index/index.vue"]]);
  const _sfc_main$8 = {
    data() {
      return {};
    },
  ...
  const PagesShouyeShouye = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__file", "D:/Uniapp/luoying/pages/shouye/shouye.vue"]]);
  const _sfc_main$7 = {
    data() {
      return {
        posts: [
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      ...
      vue.createElementVNode("swiper", {
        ...
        vue.createElementVNode("swiper-item", null, [
          vue.createElementVNode("image", {
            src: "/static/faxian/img1.png",
            class: "swiper-image"
          })
        ]),
        vue.createElementVNode("swiper-item", null, [
          vue.createElementVNode("image", {
            src: "/static/faxian/img2.jpg",
            class: "swiper-image"
          })
        ])
      ]),
            ...
            return vue.openBlock(), vue.createElementBlock("view", {
              ...
              vue.createElementVNode("view", { class: "post-header" }, [
                ...
                vue.createElementVNode("view", { class: "post-stats" }, [
                  vue.createElementVNode("image", {
                    src: "/static/faxian/view.png",
                    style: { "height": "40rpx", "width": "40rpx" }
                  }),
                  vue.createElementVNode(
                    "text",
                    { class: "views" },
                    vue.toDisplayString(post.views),
                    1
                    /* TEXT */
                  ),
                  vue.createElementVNode("image", {
                    src: "/static/faxian/comment.png",
                    style: { "height": "40rpx", "width": "40rpx" }
                  }),
                  vue.createElementVNode(
                    "text",
              ...
              vue.createElementVNode("view", { class: "post-content" }, [
                ...
                post.image && Array.isArray(post.image) ? (vue.openBlock(), vue.createElementBlock("image", {
                  key: 0,
                  src: post.image[0],
                  class: "post-image"
                }, null, 8, ["src"])) : post.image ? (vue.openBlock(), vue.createElementBlock("image", {
                  key: 1,
                  src: post.image,
                  class: "post-image"
  ...
  const PagesFaxianFaxian = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-d5906933"], ["__file", "D:/Uniapp/luoying/pages/faxian/faxian.vue"]]);
      ...
      toshouye() {
        ...
        uni.request({
          ...
          fail: (error) => {
            ...
            formatAppLog("error", "at pages/denglu/denglu.vue:96", error);
          }
        });
      },
      toLuoJia() {
  ...
  const PagesDengluDenglu = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "D:/Uniapp/luoying/pages/denglu/denglu.vue"]]);
  const _sfc_main$5 = {
    data() {
      return {
  ...
  const PagesWebviewWebview = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "D:/Uniapp/luoying/pages/webview/webview.vue"]]);
  const pages = [
    {
    ...
    },
    {
      ...
      style: {
        navigationBarTitleText: "发布你的内容吧！"
      }
    },
    {
    ...
    list: [
      {
        ...
        selectedIconPath: "static/tabbar/shouyeSelected.png"
      },
      {
        pagePath: "pages/faxian/faxian",
        text: "论坛",
        iconPath: "static/tabbar/faxian.png",
        selectedIconPath: "static/tabbar/faxianSelected.png"
      },
      {
...
详细信息：${s4}`), r3(i3);
    ...
    methods: {
      ...
      formatTimeDifference(timestamp) {
        ...
        if (difference < 6e4) {
          ...
          return `${Math.floor(difference / 6e4)}分钟前`;
        } else if (difference < 864e5) {
          return `${Math.floor(difference / 36e5)}小时前`;
        } else {
          return `${Math.floor(difference / 864e5)}天前`;
        }
      },
      startTimer() {
              ...
              vue.createElementVNode("view", { class: "content" }, [
                vue.createElementVNode("view", { class: "header" }, [
                  ...
                  vue.createElementVNode(
                    "text",
                    { class: "time" },
                    vue.toDisplayString($options.formatTimeDifference(message.timestamp)),
                    1
                    /* TEXT */
                  )
                ]),
  ...
  const PagesXiaoxiXiaoxi = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-23f3f038"], ["__file", "D:/Uniapp/luoying/pages/xiaoxi/xiaoxi.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {
        userSelf: {},
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", { class: "my-page" }, [
      ...
      vue.createElementVNode("div", { class: "menu" }, [
        ...
        vue.createElementVNode("div", {
          class: "menu-item",
          onClick: _cache[1] || (_cache[1] = (...args) => $options.showChangePasswordModal && $options.showChangePasswordModal(...args))
        }, [
          vue.createElementVNode("i", { class: "fas fa-key" }),
      ...
      $data.showEditProfileModalFlag ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
        class: "modal-overlay"
      }, [
          ...
          vue.createElementVNode("div", { class: "form-group" }, [
            ...
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                type: "text",
                id: "userId",
                "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => $data.editUser.userId = $event),
                disabled: ""
              },
              null,
              512
              ...
              [vue.vModelText, $data.editUser.userId]
            ])
          ]),
          vue.createElementVNode("div", { class: "form-group" }, [
            vue.createElementVNode("label", { for: "name" }, "用户名:"),
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                type: "text",
                id: "name",
                "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => $data.editUser.name = $event)
              },
              null,
              512
              /* NEED_PATCH */
      ...
      vue.createCommentVNode(" 悬浮修改密码页 "),
      $data.showChangePasswordModalFlag ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 1,
        class: "modal-overlay"
      }, [
        vue.createElementVNode("div", { class: "modal" }, [
          vue.createElementVNode("h3", null, "修改密码"),
          vue.createElementVNode("div", { class: "form-group" }, [
            vue.createElementVNode("label", { for: "currentPassword" }, "当前密码:"),
          ...
          vue.createElementVNode("div", { class: "form-group" }, [
            vue.createElementVNode("label", { for: "newPassword" }, "新密码:"),
            vue.createElementVNode("div", { class: "password-input" }, [
              vue.withDirectives(vue.createElementVNode("input", {
          ...
          vue.createElementVNode("div", { class: "form-group" }, [
            vue.createElementVNode("label", { for: "confirmNewPassword" }, "确认新密码:"),
            vue.createElementVNode("div", { class: "password-input" }, [
              vue.withDirectives(vue.createElementVNode("input", {
  ...
  const PagesFabuFabu = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "D:/Uniapp/luoying/pages/fabu/fabu.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        chatId: null,
    ...
    methods: {
      ...
      shouldShowTime(index) {
        ...
        return currentMsg.timestamp - previousMsg.timestamp > 5 * 60 * 1e3;
      },
  ...
  const PagesChatChat = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "D:/Uniapp/luoying/pages/chat/chat.vue"]]);
